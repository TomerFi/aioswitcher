...
# Switcher Boiler Bridge and API Tools [![PyPI version](https://badge.fury.io/py/aioswitcher.svg)](https://badge.fury.io/py/aioswitcher) [![Build Status](https://travis-ci.org/TomerFi/aioswitcher.svg?branch=unit-tests)](https://travis-ci.org/TomerFi/aioswitcher)
