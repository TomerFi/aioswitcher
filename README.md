...
- [get_token.py](https://github.com/TomerFi/aioswitcher/blob/dev/scripts/get_token.py) can get a device token which is a must for newer devices, used for communicating with devices.
