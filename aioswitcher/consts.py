...
DAYS_HEX_DICT = {0x02: MONDAY, 0x04: TUESDAY, 0x08: WEDNESDAY, 0x10: THURSDAY,
                 0x20: FRIDAY, 0x40: SATURDAY, 0x80: SUNDAY}

DAYS_INT_DICT = {MONDAY: 2, TUESDAY: 4, WEDNESDAY: 8, THURSDAY: 16, FRIDAY: 32,
                 SATURDAY: 64, SUNDAY: 128}

# weekdays, start-time, end-time
SCHEDULE_CREATE_DATA_FORMAT = ENABLE_SCHEDULE + "{}" + ENABLE_SCHEDULE + "{}{}"
