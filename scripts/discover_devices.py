...
Example:
    ...
    standard output, for example (note the ``device_id`` and ``mac_address`` properties)::
        {   '_auto_shutdown': '03:00:00',
            '_device_id': 'xxxxxx',
            '_device_state': <DeviceState.OFF: ('0000', 'off')>,
            '_device_type': <DeviceType.V2_ESP: ('Switcher V2 (esp)', 'a7', <DeviceCategory.WATER_HEATER: 1>)>,
            '_electric_current': 0.0,
            '_ip_address': '192.168.1.33',
            '_last_data_update': datetime.datetime(2021, 6, 13, 11, 11, 44, 883003),
            '_mac_address': 'XX:XX:XX:XX:XX:XX',
            '_name': 'My Switcher Boiler',
