...
async def test_api_login_success(
        ...
        api_stage_success_login: bytes) -> None:
...
async def test_api_login_fail(
        event_loop: AbstractEventLoop,
        tcp_connection: CoroutineMock,
        api_stage_failed_login: bytes) -> None:
...
async def test_api_get_state_fail(
        event_loop: AbstractEventLoop,
        tcp_connection: CoroutineMock,
        api_stage_fail_get_state: Tuple[bytes, str]) -> None:
...
async def test_api_control_success(
        event_loop: AbstractEventLoop,
        tcp_connection: CoroutineMock,
        api_stage_success_control: List[bytes]) -> None:
...
async def test_api_set_device_name_success(
        event_loop: AbstractEventLoop,
        tcp_connection: CoroutineMock,
        api_stage_success_update_name: List[bytes]) -> None:
...
async def test_api_set_auto_shutdown_success(
        event_loop: AbstractEventLoop,
        tcp_connection: CoroutineMock,
        api_stage_success_set_auto_off: List[bytes]) -> None:
...
async def test_api_get_schedules_success(
        event_loop: AbstractEventLoop,
        tcp_connection: CoroutineMock,
        api_stage_success_get_schedules: List[bytes]) -> None:
...
async def test_api_delete_schedule_success(
        event_loop: AbstractEventLoop,
        tcp_connection: CoroutineMock,
        api_stage_success_delete_schedule: List[bytes]) -> None:
...
async def test_api_create_schedule_success(
        event_loop: AbstractEventLoop,
        tcp_connection: CoroutineMock,
        api_stage_success_create_schedule: List[bytes]) -> None:
    ...
    async with SwitcherV2Api(
        ...
        reader = tcp_connection
        reader.read.side_effect = \
            api_stage_success_create_schedule
...
async def test_api_disable_enable_schedule_success(
        event_loop: AbstractEventLoop,
        tcp_connection: CoroutineMock,
        api_stage_success_en_disable_schedule: List[bytes]) -> None:
    ...
    async with SwitcherV2Api(
        ...
        reader = tcp_connection
        reader.read.side_effect = \
            api_stage_success_en_disable_schedule
