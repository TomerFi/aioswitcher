...
async def test_breeze_remote_min_max_temp(resource_path_root):
    elec7001_set = load(open((str(resource_path_root) + "/breeze_data/ELEC7001.txt")))
...
async def test_breeze_get_command_function_with_non_supported_mode(resource_path_root):
    elec7022_set = load(open((str(resource_path_root) + "/breeze_data/ELEC7022_NO_DRY.txt")))
...
async def test_breeze_get_command_function_key_not_found(resource_path_root):
    elec7022_invalid_set = load(open((str(resource_path_root) + "/breeze_data/ELEC7022_INVALID.txt")))
