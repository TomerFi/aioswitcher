...
from aioswitcher.consts import (
    HANDLED_EXCEPTIONS, SCHEDULE_DUE_ANOTHER_DAY_FORMAT,
...
from .consts import (  # noqa F401
    ...
    DUMMY_FULL_RECCURING_START_TIME, DUMMY_NON_RECCURING_DAYS_LIST,
    DUMMY_NON_RECCURING_DURATION, DUMMY_NON_RECCURING_END_TIME,
    DUMMY_NON_RECCURING_SCHEDULE_DATA, DUMMY_NON_RECCURING_SCHEDULE_DATA_BYTES,
    DUMMY_NON_RECCURING_SCHEDULE_ID, DUMMY_NON_RECCURING_START_TIME,
    DUMMY_SELECTIVE_RECCURING_DAYS_LIST, DUMMY_SELECTIVE_RECCURING_DURATION,
