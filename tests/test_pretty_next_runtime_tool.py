...
def test_pretty_next_run_with_no_selected_days_should_return_due_today():
    expected_return = "Due today at 13:00"
    assert_that(_pretty_next_run("13:00")).is_equal_to(expected_return)


def test_pretty_next_run_with_todays_day_should_return_due_today(todays_day):
    expected_return = "Due today at 13:00"
